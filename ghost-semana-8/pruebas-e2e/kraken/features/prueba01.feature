...
@user1 @web
Scenario: Loguearse, crear post, ir a pagina creada y revisar que el post se creo v4
...
@user2 @web
Scenario: Loguearse, crear post, ir a pagina creada y revisar que el post se creo v3
