...
@user1 @web
Scenario: Loguearse, crear post, editar post , no guardar, ir a pagina creada y revisar que el post no esta publicado V4
...
@user2 @web
Scenario: Loguearse, crear post, editar post , no guardar, ir a pagina creada y revisar que el post no esta publicado V3
    ...
    And I go to create a new post
    And I wait for 1 seconds
    And I create a new post with title "Post in draft" and content "Post in draft content" wihtout saving V3
    And I wait for 2 seconds
    And I go to the preview page
    And I wait for 1 seconds
Then I evaluate the title of the post "404"