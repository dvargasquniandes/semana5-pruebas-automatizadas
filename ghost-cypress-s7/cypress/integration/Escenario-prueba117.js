...
describe('Escenario de prueba 117', function () {
    before(function () {
    })
    beforeEach(function(){
        cy.visit(`${url}/ghost/`);
    ...
    it('Datos dinámicos pseudo aleatorios, Creación de un tag con color inválido y luego corregirlo', function () {
        let testData = {
            ...
            colorModificado: faker.internet.color(),
        }
        cy.log(testData);
